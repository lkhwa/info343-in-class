...
const LS_KEY = "redux-store"; //local storage
    ...
    switch(action.type) {
        case ADD_FAV_ACTION:
            return Object.assign(
                ...
                //return new array with all the element's old array + new item
                //clones into new js object
...
export function addFavorite(item) { //action creator
    return {
        type: ADD_FAV_ACTION,
        item: item
    }
