...
//string: descriptive of what you're testing
describe("redux store", function() {
    //string: describes what it should do
    //it is used to declar one test
    ...
    it("should add a favorite", function() {
        ...
        expect(state2.favorites[0]).to.deep.equal(item); //contents have the same set of properties and values
...
//test-driven development, behavior-driven development: write test first from the spec